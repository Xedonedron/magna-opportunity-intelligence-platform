                ...
                return (
                    <Card key={id} className="overflow-hidden transition-all duration-200">
                        <button
                            ...
                            className="w-full px-5 py-4 flex items-center justify-between bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800/60 transition-colors text-left"
                        >
                            <div className="flex items-center gap-4">
                                <div
                                    className={`p-1.5 rounded-md ${isOpen ? "bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900" : "bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400"}`}
                                >
                                    <Target className="w-4 h-4" />
                                </div>
                                <span className="font-medium text-zinc-900 dark:text-zinc-100">{uc.title}</span>
                            </div>
                            <div className="flex items-center gap-4">
                                <span
                        ...
                        {isOpen && (
                            <div className="px-5 py-5 border-t border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/40 space-y-5">
                                <DetailSection
...
function DetailSection({
    ...
    return (
        <div>
            <h4 className="text-xs font-semibold text-zinc-900 dark:text-zinc-100 uppercase tracking-wider mb-1.5 flex items-center gap-1.5">
                {icon} {title}
            </h4>
