...
def upgrade() -> None:
    ...
    # 1. Create ai_token_usages table if it doesn't exist
    ...
    # 2. Add user_id to opportunity_chat_messages if column does not exist
    if 'opportunity_chat_messages' in tables:
        chat_cols = [col['name'] for col in inspector.get_columns('opportunity_chat_messages')]
